...
def extract_main_content(html):
    ...
    main_content_element = soup.find('main', role='main')
...
class CdvSpider(CrawlSpider):
    name = 'cdenv'
    start_urls = ['https://www.cdenv.be/']

    rules = (
        Rule(LinkExtractor(allow=(r'^https?://(?:\w+\.)?cdenv\.be'), allow_domains="cdenv.be"),
