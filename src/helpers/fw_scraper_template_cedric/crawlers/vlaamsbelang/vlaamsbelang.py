...
def extract_main_content(html):
    ...
    main_content_element = soup.find('main', class_='main-content')
...
class VlaamsBelangSpider(CrawlSpider):
    name = 'vlaamsbelang'
    start_urls = ['https://www.vlaamsbelang.org/']

    rules = (
        Rule(LinkExtractor(allow=(r'^https?://(?:\w+\.)?vlaamsbelang\.org/search?'), allow_domains="vlaamsbelang.org"),
        ...
        Rule(LinkExtractor(allow=(r'^https?://(?:\w+\.)?vlaamsbelang\.org'), allow_domains="vlaamsbelang.org"),
